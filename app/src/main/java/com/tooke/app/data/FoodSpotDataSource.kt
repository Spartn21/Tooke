...
object FoodSpotDataSource {
    ...
    fun getAllSpots(): List<FoodSpot> = listOf(
        ...
        FoodSpot(
            ...
            location = "Near GMS Building, Mengo",
        ...
        FoodSpot(
            ...
            location = "Mengo hospital Road, 200m from campus",
        ...
        FoodSpot(
            ...
            location = "Ndejje University Extension Gate, Ndejje Kampala",
        ...
        FoodSpot(
            ...
            location = "Mengo Road Junction, near Kampala Campus",
